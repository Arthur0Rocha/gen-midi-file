...
if __name__ == "__main__":
    ...
    NOTE_CRASH = 49
    inputs = [
        (0, DRUM_CH, 'note_on', 35, 127),
        (0, DRUM_CH, 'note_on', 42, 127),
        (DIVISIONS, DRUM_CH, 'note_off', 35, 0),
        (0, DRUM_CH, 'note_off', 42, 0),
        (0, DRUM_CH, 'note_on', 42, 127),
        (DIVISIONS, DRUM_CH, 'note_off', 42, 0),
        (0, DRUM_CH, 'note_on', 42, 127),
        (0, DRUM_CH, 'note_on', 38, 127),
        (DIVISIONS, DRUM_CH, 'note_off', 42, 0),
        (0, DRUM_CH, 'note_off', 38, 0),
        (0, DRUM_CH, 'note_on', 42, 127),
        (DIVISIONS, DRUM_CH, 'note_off', 42, 0),
        ...
        (0, DRUM_CH, 'note_on', 42, 127),
        (DIVISIONS, DRUM_CH, 'note_off', 42, 0),
        (0, DRUM_CH, 'note_on', 49, 127),
        (3*DIVISIONS, DRUM_CH, 'note_off', 49, 0),
